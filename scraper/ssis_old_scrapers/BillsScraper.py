...
options.add_experimental_option("prefs", {
  "download.default_directory": 'C:\\Users\\student\\Desktop\\SSIS Related- Re Moe\\hansard_debates_Q&A-1Year\\Bill',
...
time.sleep(3)
driver.find_element_by_xpath(("//*[@title=\"Refine by: Bills\"]")).click() 
time.sleep(3)
