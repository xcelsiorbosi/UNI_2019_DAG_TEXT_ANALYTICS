...
time.sleep(3)
driver.find_element_by_xpath(("//*[@title=\"Refine by: Answers to Questions\"]")).click() #this will select only debates
time.sleep(3)
...
allHrefs = []       #creaing empty list to add links of individual pdf later
dictionary = {}     #creting empty dictionary
...
driver.close()
print(dictionary)
allHrefs=dictionary.values()    #allHrefs has links to all pdf file
