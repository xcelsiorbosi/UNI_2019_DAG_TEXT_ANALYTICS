...
options.add_experimental_option("prefs", {
  "download.default_directory": 'C:\\Users\\student\\Desktop\\SSIS Related- Re Moe\\hansard_debates_Q&A-1Year\\QT', #path of folder where xmls needs to be saved
...
driver.find_element_by_class_name('hansard-search-button').click() #it clecks search icon in the page after dates are specified
time.sleep(3)
